...
ibague_mzn['porc_con_internet'] = (
    ibague_mzn['TP19_INTE1']/ibague_mzn['TVIVIENDA'])*100
ibague_mzn2 = ibague_mzn[["LATITUD", "LONGITUD", "TP19_INTE1", "TVIVIENDA", "TP16_HOG", 'TP34_1_EDA',
...
# modelo=get_df_model()
ibague_mzn['PORC_VIVIENDA'] = (
    ibague_mzn['TP9_1_USO']/ibague_mzn['TVIVIENDA'])*100
ibague_mzn['PORC_OTROSUSOS'] = 100-ibague_mzn['PORC_VIVIENDA']
ibague_mzn['PORC_ENERGIA'] = (
    ibague_mzn['TP19_EE_1']/ibague_mzn['TVIVIENDA'])*100
...
ibague_mzn['PORC_ACUE'] = (
    ibague_mzn['TP19_ACU_1']/ibague_mzn['TVIVIENDA'])*100
...
ibague_mzn['PORC_0_9'] = (ibague_mzn['TP34_1_EDA'] /
                          ibague_mzn['TP27_PERSO'])*100
ibague_mzn['PORC_10_19'] = (
    ibague_mzn['TP34_2_EDA']/ibague_mzn['TP27_PERSO'])*100
ibague_mzn['PORC_20_29'] = (
    ibague_mzn['TP34_3_EDA']/ibague_mzn['TP27_PERSO'])*100
ibague_mzn['PORC_30_39'] = (
    ibague_mzn['TP34_4_EDA']/ibague_mzn['TP27_PERSO'])*100
ibague_mzn['PORC_40_49'] = (
    ibague_mzn['TP34_5_EDA']/ibague_mzn['TP27_PERSO'])*100
ibague_mzn['PORC_50_59'] = (
    ibague_mzn['TP34_6_EDA']/ibague_mzn['TP27_PERSO'])*100
ibague_mzn['PORC_60_69'] = (
    ibague_mzn['TP34_7_EDA']/ibague_mzn['TP27_PERSO'])*100
ibague_mzn['PORC_70_79'] = (
    ibague_mzn['TP34_8_EDA']/ibague_mzn['TP27_PERSO'])*100
ibague_mzn['PORC_80'] = (ibague_mzn['TP34_9_EDA']/ibague_mzn['TP27_PERSO'])*100
ibague_mzn['PORC_PREE'] = (
    ibague_mzn['TP51PRIMAR']/ibague_mzn['TP27_PERSO'])*100
ibague_mzn['PORC_SEC'] = (ibague_mzn['TP51SECUND'] /
                          ibague_mzn['TP27_PERSO'])*100
ibague_mzn['PORC_0_TP'] = (
    ibague_mzn['TP51SUPERI']/ibague_mzn['TP27_PERSO'])*100
ibague_mzn['PORC_POST'] = (
    ibague_mzn['TP51POSTGR']/ibague_mzn['TP27_PERSO'])*100
ibague_mzn['PORC_NIN'] = (ibague_mzn['TP51_13_ED'] /
                          ibague_mzn['TP27_PERSO'])*100
...
app.layout = html.Div(
    [
        ...
        html.Div([html.Div(html.H3("  "), className="two columns"),
            ...
            [dbc.Tabs(
                [
                    dbc.Tab(label='ESTADÍSTICAS', tab_id='estad', id='estad-tab', label_style={
                            "font-size": '23px', 'border-radius': '6px', "margin-right": "10px", "width": "190px", "text-align": "center"}),
                    dbc.Tab(label='DEMOGRAFÍA', tab_id='demograf', id='estad-tab3', label_style={
                            "font-size": '23px', 'border-radius': '6px', "margin-right": "10px", "width": "190px", "text-align": "center"}),
                    dbc.Tab(label='PROYECCIÓN', tab_id='modelo', id='estad-tab2', label_style={
                            "font-size": '23px', 'border-radius': '6px', "margin-right": "10px", "width": "190px", "text-align": "center"}),
                    dbc.Tab(label='POTENCIAL', tab_id='potencial', label_style={
                            "font-size": '23px', 'border-radius': '6px', "width": "190px", "text-align": "center"})
                ],
                id='tabs_id',
                active_tab='estad',
                style={
                    'border': 'rgba(0, 0, 0, 0)', 'padding-top': '7px', 'padding-bottom': '10px'}
        ...
        dcc.Loading(html.Div(className="row flex-display",
                    id='midContainer2'), color='#13c6e9'),
    ...
    if active == 'modelo':
            ...
            html.Div([
                ...
                dbc.Card([
                    ...
                    dbc.Modal(
                        [
                            ...
                            dbc.ModalBody(
                                "Este indicador muestra la probabilidad de que las personas en el área de cobertura (300 metros alrededor) se conecten al menos dos veces al día a una Zona Vibra localizada en el punto seleccionado"),
                ...
                dbc.Card([
                    ...
                    dbc.Modal(
                        [
                            dbc.ModalHeader(
                                "Probabilidad de no proximidad"),
                            dbc.ModalBody(
                                "Este indicador muestra la probabilidad de estar ubicado alejado de una Zona Vibra según las características demográficas de la manzana"),
                ...
                dbc.Card([
                     ...
                     dbc.Modal(
                         [
                             ...
                             dbc.ModalBody(
                                 "Se muestran indicadores con base en el Censo Nacional de Población y Vivienda 2018 de las manzanas en un radio de 300 metros alrededor del punto seleccionado"),
                     ...
                     dbc.Modal(
                         [
                             dbc.ModalBody(html.H4(
                                 "Seleccione un punto en el mapa para conocer las proyecciones al instalar una nueva Zona Vibra")),
        ...
        container = [
            html.Div([
                ...
                html.Div([
                    ...
                    dbc.Modal(
                        [
                            ...
                            dbc.ModalBody(
                                "Puede filtrar las Zonas Vibra actuales por Comuna y por Zonas Vibra individuales, puede ocultar las Zonas Vibra haciendo click en la leyenda del mapa ubicada arriba a la izquierda"),
                ...
                html.Div(dcc.Graph(id='gauge', style={
                         'padding-top': '95px'}),),
            ...
            html.Div(
                [
                    ...
                    html.H4('Tipos de uso', id='fig3-title',
                ...
                html.Div([
                    ...
                    dbc.Modal(
                        [
                            ...
                            dbc.ModalBody(
                                "Puede crear un mapa de calor con variables demográficas del Censo Nacional de Población y Vivienda 2018, puede ocultar las Zonas Vibra haciendo click en la leyenda del mapa ubicada arriba a la izquierda"),
                    ...
                    html.H3('Variable del CNPV 2018',
                            style={'padding-top': '15px'}),
                    dcc.Dropdown(
                        id='type-variable',
                        options=[{'label': i, 'value': i}
                                 for i in df_var[df_var['INCLUIR'] == 'SI']['DESCRIPCIÓN']],
                        style={'font-size': '12px'},
                        clearable=False,
                        value='NINGUNA'
                    )],
        ...
        container = [
            html.Div([
                ...
                dbc.Card([
                    dbc.CardHeader(
                        html.H3("Potencial en zona urbana", className="card-title"),),
                    dbc.CardBody(
                        [
...
def click_coord(e):
    if e is not None:
        ...
        df2['pct_30_39'] = df2['TP34_4_EDA']/df2[['TP34_1_EDA', 'TP34_2_EDA', 'TP34_3_EDA', 'TP34_4_EDA',
                                                  'TP34_5_EDA', 'TP34_6_EDA', 'TP34_7_EDA', 'TP34_8_EDA', 'TP34_9_EDA']].sum(axis=1)
        df2['pct_internet'] = df2['TP19_INTE1']/df2['TVIVIENDA']
        df2['hogares_vivienda'] = df2['TP16_HOG']/df2['TVIVIENDA']
        probability2 = 19.7964 - \
            (4.9049*df2['pct_internet'])-(13.1793 *
                                          df2['hogares_vivienda'])-(41.7552*df2['pct_30_39'])
        probability2 = str(round(math.exp(probability2) /
                           (1+math.exp(probability2))*100, 0)) + " %"
        ...
        for i in range(0, len(ibague_mzn.index)):
            ...
            if distance < distance_min:
                ...
                closest_block = i
        prob_logit = str(
            round(ibague_mzn.iloc[closest_block]['prob_logit'], 0)) + " %"
        g = geocoder.mapbox(
            e, method='reverse', key='pk.eyJ1IjoiY2FybG9zcnVpeiIsImEiOiJja3JrdzMwODkyNG9rMm5vMjMwamt0MTdoIn0.9aeH5Caw5g8GDmEEePpjow')
        location = g.address
        ...
        hombres = str(
            round((df['TP32_1_SEX'].sum()/df['TP27_PERSO'].sum())*100, 1)) + "% hombres"
        mujeres = str(
            round((df['TP32_2_SEX'].sum()/df['TP27_PERSO'].sum())*100, 1)) + "% mujeres"
        viviendas = str(
            round((df['TP9_1_USO'].sum()/df['TVIVIENDA'].sum())*100, 1)) + "% de viviendas"
        otros = str(round(
            100-(df['TP9_1_USO'].sum()/df['TVIVIENDA'].sum())*100, 1)) + "% de otros usos"
        ...
        max_e = est[0][ind]
        estrato = max_e + \
            " (" + str(round((est['num'][ind]/est['num'].sum())
                             * 100, 1)) + "% de las viviendas)"
        con_int = str(round((df['TP19_INTE1'].sum(
        )/df['TVIVIENDA'].sum())*100, 1)) + "% de viviendas con internet"
        ed1 = str(round((df['TP34_1_EDA'].sum()/df['TP27_PERSO'].sum())
                  * 100, 1)) + "% de personas entre 0-9 años"
        ed2 = str(round((df['TP34_2_EDA'].sum()/df['TP27_PERSO'].sum())
                  * 100, 1)) + "% de personas entre 10-19 años"
        ed3 = str(round((df['TP34_3_EDA'].sum()/df['TP27_PERSO'].sum())
                  * 100, 1)) + "% de personas entre 20-29 años"
        ed4 = str(round(((df['TP34_4_EDA'].sum()+df['TP34_5_EDA'].sum()) /
                  df['TP27_PERSO'].sum())*100, 1)) + "% de personas entre 30-49 años"
        ed5 = str(round(((df['TP34_6_EDA'].sum()+df['TP34_7_EDA'].sum()) /
                  df['TP27_PERSO'].sum())*100, 1)) + "% de personas entre 50-69 años"
        ed6 = str(round(((df['TP34_8_EDA'].sum()+df['TP34_9_EDA'].sum()) /
                  df['TP27_PERSO'].sum())*100, 1)) + "% de personas con más de 70 años"

        edu1 = str(round((df['TP51PRIMAR'].sum()/df['TP27_PERSO'].sum())
                   * 100, 1)) + "% con nivel educativo primaria"
        edu2 = str(round((df['TP51SECUND'].sum()/df['TP27_PERSO'].sum())
                   * 100, 1)) + "% con nivel educativo secundaria"
        edu3 = str(round((df['TP51SUPERI'].sum()/df['TP27_PERSO'].sum())
                   * 100, 1)) + "% con nivel educativo universitario"
        edu4 = str(round((df['TP51POSTGR'].sum()/df['TP27_PERSO'].sum())
                   * 100, 1)) + "% con nivel educativo posgrado"
...
def update_mainmap_comuna(comuna, zonas):
    ...
    if (comuna == 'total') & (len(zonas) == 0):
        ...
        figa.add_scatter(x=df_mes['Mes'], y=df_mes['Conexiones'],
                         marker_color='#13c6e9', marker_size=12)
        figa['layout'].update(margin=dict(l=0, r=0, b=0, t=0), showlegend=False, paper_bgcolor='rgba(0, 0, 0, 0)', height=220, font={
                              'color': '#aaa'}, plot_bgcolor='rgba(0, 0, 0, 0)')
        ...
        fig = figa
        figb = px.treemap(df_u, path=[
                          'USO'], values='PROMEDIO', color_discrete_sequence=px.colors.qualitative.G10, )
        figb.update_layout(margin=dict(t=0, l=0, r=0, b=0),
        ...
        fig4['layout'].update(margin=dict(
            l=0, r=0, b=0, t=0),  paper_bgcolor='rgba(0, 0, 0, 0)', height=200, font={'color': '#aaa'})
        figg = fig4
